        ...
        return (
            <li onClick={this.loadWall} className="user-itemizer">
                <Link className="avatar" to={hrefPlaceholder}>
                    <img className="profile-photo-med round-50" src={(typeof this.props.user.ouuid !== 'undefined') ? URLGenerator.generate75(this.props.user.ouuid):"https://s3-us-west-2.amazonaws.com/wondrousstatic/pictures/defaults/p.default-profile-picture.jpg"} />
                </Link>
